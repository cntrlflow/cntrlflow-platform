...
export const LOGIN_URL: string = "https://localhost:8443/api/auth/login";
//export const VALIDATE_URL: string = "/api/auth/validate";
export const VALIDATE_URL: string = "https://localhost:8443/api/auth/validate";
//export const LOGOUT_URL: string = "/api/auth/logout";
export const LOGOUT_URL: string = "https://localhost:8443/api/auth/logout";
